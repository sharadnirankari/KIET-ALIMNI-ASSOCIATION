    ...
    <div class="min-width">
        <div class="fullwidth whiteBg">
            ...
            <div id="iframe-container" style="overflow: hidden;">
                <iframe id="myIframe" class="fullwidth" src="https://kiet.almaconnect.com/event_calendar?frm=sb_list" style="border: 0; width:100%; height:500px; overflow:hidden;">Your browser doesn't support iFrames.</iframe>
            </div>
